...
\begin{frame}
  \begin{figure}
      \centering
      \includegraphics[height=0.9\textheight, trim=0.5cm 0.5cm 0.4cm 2cm,clip=true]{{plots/annihilation/all_standardrock_stats_10000_Emin_8.0_Emax_8.0_index_1}.pdf}
      \caption*{Energieverluste von $\num{e4}$ $e^+$ einer Startenergie von $\SI{e8}{\mega\electronvolt}$ durch Gestein, $E_\text{cut} = \SI{500}{\mega\electronvolt}$.}
      \label{fig:1}
  \end{figure}
\end{frame}
