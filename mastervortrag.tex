...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{daten/xy_1e5.jpg}
          \caption*{$E = \SI{e5}{\mega\electronvolt}$}
      \end{figure}
    \end{column}
    ...
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{daten/xy_1e6.jpg}
          \caption*{$E = \SI{e6}{\mega\electronvolt}$}
      \end{figure}
    \end{column}
    ...
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{daten/xy_1e7.jpg}
          \caption*{$E = \SI{e7}{\mega\electronvolt}$}
      \end{figure}    
    \end{column}
  \end{columns}
