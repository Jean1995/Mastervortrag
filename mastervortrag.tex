...
\begin{frame}
      ...
      Ziel ist es ein Monte-Carlo Programm zu entwickeln, welches einerseits die bei der Propagation von Leptonen auftauchende \textcolor{red}{große Anzahl} an Wechselwirkungen (einige tausend)
      mit \textcolor{red}{großer Genauigkeit} beschreibt und andererseits den algorithmischen Fehler so gering wie möglich hält. 
      \end{aquote}
\end{frame}
...
\begin{frame}
  \begin{itemize}
    ...
    \item Simulation der Wechselwirkungen von hochenergetischen Teilchen
    \begin{itemize}
      \item[$\rightarrow$] Energieverluste
      \item[$\rightarrow$] Vielfachstreuung
      \item[$\rightarrow$] Zerfall
    \end{itemize}
    \item Verschiedene Wechselwirkungsparametrisierungen verfügbar
    \begin{itemize}
      \item[$\rightarrow$] Untersuche Auswirkungen auf Simulationen
    \end{itemize}
    \item Nutzung von Interpolationstabellen
  \end{itemize}
\end{frame}
...
\begin{frame}
  \begin{figure}
      ...
      \caption*{Propagation von $\num{5e4}$ Myonen einer Startenergie von $\SI{e8}{\mega\electronvolt}$ durch $\SI{300}{\metre}$ Stein.}
      \label{fig:1}
      \end{overprint}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
      \centering
      \includegraphics[height=0.85\textheight, trim=0.5cm 0.5cm 0.4cm 0.0cm,clip=true]{{plots/dEdx/dEdx}.pdf}
      \caption*{Kontinuierliche Energieverluste von Myonen in Stein.}
      \label{fig:1}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{plots/shower_2d/xy_1e5.jpg}
          \caption*{$E = \SI{e5}{\mega\electronvolt}$}
      \end{figure}
    \end{column}
    ...
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{plots/shower_2d/xy_1e6.jpg}
          \caption*{$E = \SI{e6}{\mega\electronvolt}$}
      \end{figure}
    \end{column}
    ...
    \begin{column}{0.33\textwidth}
      \begin{figure}
          \centering
          \includegraphics[height=0.6\textheight]{plots/shower_2d/xy_1e7.jpg}
          \caption*{$E = \SI{e7}{\mega\electronvolt}$}
      \end{figure}    
    \end{column}
  \end{columns}
